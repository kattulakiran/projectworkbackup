...
@Entity
@Table(name="theftclaim")
public class TheftClaimDTO {
	...
	public TheftClaimDTO(String policy_id, String username, int total_amount, Date date_of_theft,
			Date date_of_complaint, String fir_number, String police_station_branch, String claim_id) {
		super();
		this.policy_id = policy_id;
		this.username = username;
		this.total_amount = total_amount;
